...
@Component({
  selector: 'app-transactions-users',
  templateUrl: './transactions-users.page.html',
  styleUrls: ['./transactions-users.page.scss'],
})
export class TransactionsUsersPage implements OnInit {
